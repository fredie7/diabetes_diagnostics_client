...
function App() {
  ...
  const [veryLowDensityLipoprotein, setVeryLowDensityLipoprotein] =
    useState("");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const run_diagnosis = await fetch(
        "https://diabetes-diag-api.onrender.com/predict",
        {
          method: "POST",
          headers: {
  ...
  return (
    <div className="app">
      ...
      <div className="wrapper">
        ...
        <h4 className="header">
          Complete the following enteries to confirm your diabetes status:
        </h4>
        <form action="" className="form-doc">
          ...
          <input
            className="form-input"
            type="text"
            onChange={(e) => setCreatinineRatio(e.target.value)}
            value={creatinineRatio}
            placeholder="Enter creatinine ratio"
          />
          <input
            className="form-input"
            type="text"
            ...
            placeholder="Enter glycated hemoglobin level"
          />
          <input
            className="form-input"
            type="text"
          ...
          <input
            ...
            value={triglycerides}
            placeholder="Enter fat lipid type(Triglycerides)"
          />
          <input
            className="form-input"
            type="text"
            ...
            placeholder="Enter high density lipoprotein level"
          />
          <input
            className="form-input"
            type="text"
            onChange={(e) => setLowDensityLipoprotein(e.target.value)}
            value={lowDensityLipoprotein}
            placeholder="Enter low density lipoprotein level"
          />
          <input
            className="form-input"
            type="text"
            onChange={(e) => setVeryLowDensityLipoprotein(e.target.value)}
            value={veryLowDensityLipoprotein}
            placeholder="Enter very low density lipoprotein level"
          />
          <input
            className="form-input"
            type="text"
            ...
            value={bmi}
            placeholder="Enter body mass iindex"
          />
